...
#ifndef _JSON_NOM_NOM_H_
#define _JSON_NOM_NOM_H_

#include <yajl/yajl_tree.h>

/**
 * For each property in a node, mask identically named properties in subnodes.
 *
 * @param node The YAJL node to be processed
 */
